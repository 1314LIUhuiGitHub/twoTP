...
return  [
	...
	// | 系统数据加密设置
	// +----------------------------------------------------------------------
	'data_auth_key' => 'A[oxk7"vzE;ery8^p$.g=XT@]_9mh1nQ~(-+N,|j', //默认数据加密KEY
	'data_cache_key'=> 'A[oxk7"vzE;ery8^p$.g=XT@]_9mh1nQ~(-+N,|j',
    // +----------------------------------------------------------------------
    // | UCenter客户端配置
    // +----------------------------------------------------------------------
    'uc_app_id'   => 1,   //应用ID
    'uc_api_type' =>'Model',    //可选值 Model / Service
    'uc_auth_key' =>'A[oxk7"vzE;ery8^p$.g=XT@]_9mh1nQ~(-+N,|j', //加密KEY
