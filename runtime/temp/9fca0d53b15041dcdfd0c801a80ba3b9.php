...
<body>
	...
	<form action="<?php echo url(); ?>" method="post" class="form-horizontal">
		<div class="form-item">
			...
			<div class="controls">
				<input type="text" class="text input-large" name="name" value="<?php echo (isset($Property['name']) && ($Property['name'] !== '')?$Property['name']:''); ?>">
			</div>
		</div>
		<div class="form-item">
			<label class="item-label">联系电话<span class="check-tips">（联系电话）</span></label>
			<div class="controls">
				<input type="text" class="text input-large" name="tel" value="<?php echo (isset($Property['tel']) && ($Property['tel'] !== '')?$Property['tel']:''); ?>">
			</div>
		</div>
		<div class="form-item">
			<label class="item-label">详细地址<span class="check-tips">（住户楼号、门牌号）</span></label>
			<div class="controls">
				<input type="text" class="text input-large" name="address" value="<?php echo (isset($Property['address']) && ($Property['address'] !== '')?$Property['address']:''); ?>">
			</div>
		</div>
		<div class="form-item">
			<label class="item-label">报修说明<span class="check-tips">（维修物品详细说明）</span></label>
			<div class="controls">
				<label class="textarea input-large">
					<textarea name="intro"><?php echo (isset($Property['intro']) && ($Property['intro'] !== '')?$Property['intro']:''); ?></textarea>
				</label>
			</div>
		</div>
		<div class="form-item">
			<input type="hidden" name="id" value="<?php echo (isset($Property['id']) && ($Property['id'] !== '')?$Property['id']:''); ?>">
