<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:98:"D:\PhpStudy20180211\PHPTutorial\WWW\twoTP\public/../application/home/view/default/index\index.html";i:1526293015;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="utf-8">
...
<div class="main">
    ...
    <nav class="navbar navbar-default navbar-fixed-bottom">
        <div class="container-fluid text-center">
            ...
            <div class="col-xs-3">
                <p class="navbar-text"><a href="/static/static/frontend/index/fuwu.html" class="navbar-link">服务</a></p>
            </div>
            <div class="col-xs-3">
                <p class="navbar-text"><a href="/static/static/frontend/index/faxian.html" class="navbar-link">发现</a></p>
            </div>
            <div class="col-xs-3">
                <p class="navbar-text"><a href="<?php echo url('My/show'); ?>" class="navbar-link">我的</a></p>
            </div>
        </div>
    </nav>
    <!--导航结束-->
    ...
    <div class="container-fluid">
        <div class="indexImg row">
            <img src="/static/static/frontend/image/index.png" width="100%" />
        </div>
        <div class="serviceList text-center">
            <div class="container">
                <div class="row">
                    <div class="col-xs-4">
                        <a href="<?php echo url('sort/notice'); ?>">
                    ...
                    <div class="col-xs-4">
                        <a href="<?php echo url('sort/service'); ?>">
                    ...
                    <div class="col-xs-4">
                        <a href="<?php echo url('sort/online'); ?>">
