...
<div class="cf">
    ...
    <div class="search-form fr cf">
        <div class="sleft">
            <input type="text" name="title" class="search-input" value="<?php echo input('title'); ?>" placeholder="请输入维修人">
...
<div class="data-table table-striped">
    <form class="ids">
        <table>
            ...
            <tbody>
            <?php if(!(empty($Property) || (($Property instanceof \think\Collection || $Property instanceof \think\Paginator ) && $Property->isEmpty()))): if(is_array($Property) || $Property instanceof \think\Collection || $Property instanceof \think\Paginator): $i = 0; $__LIST__ = $Property;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$Property): $mod = ($i % 2 );++$i;?>
            <tr>
